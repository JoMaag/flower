...
6. Zero Gradient:          Byzantine agent sends a zero vector (simulates silent failure)
7. Reward Flipping:        Byzantine agent negates all rewards during trajectory collection
"""
