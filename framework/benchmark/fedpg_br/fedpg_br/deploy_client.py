"""Distributed deployment client for FedPG-BR.
...
from fedpg_br.config import get_config
from fedpg_br.flower.worker import Worker
from fedpg_br.client_app import FedPGClient
...
def start_client(
    ...
    client = FedPGClient(worker=worker)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="FedPG-BR Deployment Client")
