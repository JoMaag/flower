"""Distributed deployment server for FedPG-BR.
...
def start_server(
    ...
    """
    log(INFO, f"Starting FedPG-BR server on {server_address}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="FedPG-BR Deployment Server")
